...
```{r}
tableone::CreateTableOne(data = candida_data.filtered, vars = table_vars, strata = "candidemia", addOverall = T)
```
...
## Figure 2 Treatment sequences in patients with Candida bloodstream infections
